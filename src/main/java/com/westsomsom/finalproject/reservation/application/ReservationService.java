...
public class ReservationService {
    ...
    //몇번째인지 확인
    public void joinQueue(String date, String timeSlot, String memberId) {
        String queueKey = REDIS_QUEUE_KEY + date + ":" + timeSlot;
        //String uniqueUsersKey = UNIQUE_USERS_KEY + date + ":" + timeSlot;
    ...
    //대기열 상태 확인
    public void getQueueStatus(String date, String timeSlot, String memberId) {
        String queueKey = REDIS_QUEUE_KEY + date + ":" + timeSlot;
        ...
        log.info("현재 {}번째입니다. 뒤에 {}명 있습니다.", position+1, peopleBehind);
    }
    //예약 처리 스케줄러
        ...
        for (String slotKey : availableSlotsKeys) {
            ...
            while (availableSlots > 0) {
                ...
                reservationRepository.save(Reservation.builder()
                        .date(slotKey.split(":")[1])
                        .timeSlot(slotKey.split(":")[2])
                        .user(nextUserId)
